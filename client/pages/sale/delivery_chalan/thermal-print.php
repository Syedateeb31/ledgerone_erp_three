...
<head>
    ...
    <title>Thermal Print - Delivery Chalan</title>
    <style>
        /* Delivery Chalan: hide price/discount/totals */
        .disc-col, #discountRow, #gstRow,
        #totalBill, #netAmount, #amountPaid,
        #amountReturned, #remainingBalance,
...
<body>
    ...
    <div class="thermal-receipt">
        ...
        <div class="text-center invoice-header">DELIVERY CHALAN</div>
        ...
        <table class="items-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 25%;" class="text-right">Unit</th>
                </tr>
            </thead>
