...
$stmt = $pdo->prepare("
    SELECT 
        ...
        c.zipcode,
        c.logo_url
    FROM inward_gatepass ig
    LEFT JOIN suppliers s ON ig.supplier_id = s.id
...
<head>
    ...
    <title>Print Inward Gatepass - <?php echo htmlspecialchars($gatepass['gatepass_code']); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="print-container">
        ...
        <div class="info-section">
            <div class="info-box">
                ...
                <p><strong>IGP Code:</strong> <?php echo htmlspecialchars($gatepass['gatepass_code']); ?></p>
        ...
        <div class="info-box">
            ...
            <p><strong>Name:</strong> <?php echo htmlspecialchars($gatepass['supplier_name']); ?></p>
            <p><strong>Address:</strong> <?php echo htmlspecialchars($gatepass['supplier_address'] ?? 'N/A'); ?></p>
            <p><strong>Phone:</strong> <?php echo htmlspecialchars($gatepass['supplier_phone'] ?? 'N/A'); ?></p>
        </div>
