...
<head>
    ...
    <title>Outward Gatepass List - LedgerOne ERP</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="../../../assets/css/inventory/outward_gatepass/gatepass-list.css">
</head>
...
<body>
    <div class="container">
        ...
        <div class="header">
            <div class="title-section">
                <h1>Outward Gatepass List</h1>
                <p>View and manage all outward gatepass entries</p>
            </div>
        ...
        <div class="search-filter-bar">
            <div class="search-box">
                <input type="text" id="search-input" placeholder="Search by OGP code, customer, or product...">
    ...
    <script src="../../../assets/js/inventory/outward_gatepass/gatepass-list.js"></script>
</body>
