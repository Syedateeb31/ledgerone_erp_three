...
<head>
    ...
    <title>Outward Gatepass Entry - LedgerOne ERP</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="../../../assets/css/inventory/outward_gatepass/gatepass-add.css">
</head>
...
<body>
    <div class="container">
        <div class="page-header">
            <div class="title-section">
                <h1>Outward Gatepass Entry</h1>
                <p>Create new outward gatepass for dispatched goods</p>
            </div>
        </div>
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        <label for="igp-code" class="form-label">OGP Code</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="helper-text">Date of outward gatepass</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="searchable-dropdown" id="supplier-dropdown">
                            <div class="dropdown-toggle">
                                <input type="text" id="supplier" class="form-input" placeholder="Select customer"
                                    readonly required>
                                <span class="dropdown-arrow">▼</span>
                            </div>
                            <div class="dropdown-menu" id="supplier-menu">
                                <div class="dropdown-search">
                                    <input type="text" placeholder="Search customers..." id="supplier-search">
                                </div>
                        ...
                        <div class="helper-text">Select customer from list</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="helper-text">Select dispatching branch</div>
                    </div>
                </div>
            </div>
    ...
    <script src="../../../assets/js/inventory/outward_gatepass/gatepass-add.js"></script>
</body>
