...
<body>
        ...
        <form id="productForm" class="card">
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group optional-field" data-field="taxRegime">
                        <label>Tax Regime</label>
                        <select id="taxRegime" name="taxRegime">
                            <option value="">Select Tax Regime</option>
                            <option value="1">Standard GST</option>
                            <option value="2">Third Schedule - MRP Inclusive</option>
                            <option value="15">MRP-Based - Tax Exclusive</option>
                            <option value="16">Eighth Schedule</option>
                            <option value="3">Zero-Rated Exports</option>
                            <option value="4">Exempt</option>
                            <option value="17">FED Plus GST</option>
                            <option value="13">Fixed Tax Tier2</option>
                            <option value="special_procedure">Special Procedure</option>
                        </select>
                    </div>
                    
                    <div class="form-group optional-field" data-field="hsCode">
                        <label>HS Code</label>
                        <input type="text" id="hsCode" name="hsCode" placeholder="Enter HS Code">
                    </div>
                </div>
                
                <div id="eighthScheduleWarning" style="display: none; background: #e3f2fd; border: 2px solid #2196f3; border-radius: 8px; padding: 16px; margin-top: 16px;">
                    <div style="display: flex; gap: 12px;">
                        <div style="color: #2196f3; font-size: 20px; flex-shrink: 0;">ℹ️</div>
                        <div>
                            <div style="font-weight: 600; color: #1976d2; margin-bottom: 8px;">Eighth Schedule — Reduced Rate Selected</div>
                            <div style="font-size: 13px; color: #0d47a1; line-height: 1.6;">
                                <p style="margin: 0 0 8px 0;">Tax rate for this product will be automatically resolved from the HS Code you enter below.</p>
                                <p style="margin: 0 0 8px 0; font-weight: 500;">HS Code is MANDATORY for Eighth Schedule products. Without a valid HS Code, the system cannot determine the correct reduced rate and will default to 18%.</p>
                                <div style="background: white; padding: 8px; border-radius: 4px; margin: 8px 0; font-family: monospace; font-size: 12px;">
                                    Current rate for HS Code <span id="displayHsCode" style="font-weight: 600;">____</span>: <span id="displayTaxRate" style="font-weight: 600;">__</span>%<br>
                                    Legal reference: <span id="displayLegalRef" style="font-weight: 600;">___________________</span>
                                </div>
                                <p style="margin: 8px 0 0 0; color: #2e7d32;">✅ Input tax on purchases of this product is claimable.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="../../../assets/js/inventory/products/product-add.js?v=<?php echo time(); ?>"></script>
</body>
</html>