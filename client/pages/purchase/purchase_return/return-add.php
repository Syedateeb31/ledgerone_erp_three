...
<head>
    ...
    <title>LedgerOne ERP - Purchase Return</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="../../../assets/css/purchase/purchase_return/return-add.css">
</head>
<body class="light-theme">
    <div class="container">
        <div class="header">
            ...
            <button type="button" class="btn btn-secondary" id="invoiceSettingsBtn">
                <i class="fas fa-cog"></i> Return Settings
            </button>
        </div>
                    ...
                    <table id="itemsTable">
                        <thead>
                            <tr>
                                ...
                                <th width="5%" data-col="tax-percent">Tax %</th>
                                <th width="8%" data-col="tax-amount">Tax Amt</th>
    ...
    <div class="modal" id="settingsModal">
        <div class="modal-content">
            ...
            <div class="form-group">
                <label>
                    <input type="checkbox" id="enableInvoiceCashDiscount"> Enable Return-wise Cash Discount %
                </label>
            </div>
            <div class="form-group">
                <label>
                    <input type="checkbox" id="enableInvoiceCashDiscountAmount"> Enable Return-wise Cash Discount Amount
                </label>
            </div>
            <div class="form-group">
                <label>
