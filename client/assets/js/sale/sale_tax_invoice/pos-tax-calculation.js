...
async function calculateProductTax(customerId, productId, salePriceSetting = 'trade_price') {
    ...
    try {
        const response = await fetch(`../../../../server/api/sale/sale_tax_invoice/calculate-tax.php?customer_id=${customerId}&product_id=${productId}&sale_price_setting=${salePriceSetting}`);
