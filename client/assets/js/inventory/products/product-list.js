        ...
        row.innerHTML = `
                    ...
                    <td>
                        <div class="action-buttons">
                            ...
                            <button class="btn btn-icon btn-ghost print-code" data-id="${product.id}" data-qr="${product.qrCode || ''}" data-barcode="${product.barcode || ''}" data-name="${product.name}" title="Print Code">
...
function printCode(qr, barcode, productName) {
    ...
    document.getElementById('confirmPrintCode').onclick = () => {
        ...
        printWindow.document.write('<style>body{text-align:center;padding:20px;}img{margin:20px;page-break-inside:avoid;}</style>');
