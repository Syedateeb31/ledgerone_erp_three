...
try {
    ...
    $data = [
        ...
        'supplier_type' => trim($input['supplierType']),
    ...
    // Insert supplier
    $sql = "INSERT INTO suppliers (id, tenant_id, company_id, supplier_code, supplier_type, supplier_name, address, primary_phone, secondary_phone, identity_card_no, email, opening_debit_amount, opening_credit_amount, ait_percent, is_blacklisted, created_by, updated_by) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
