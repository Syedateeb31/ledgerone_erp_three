...
try {
    ...
    // 4. Get suppliers with opening balances
    ...
    echo json_encode([
        'success' => true,
        'message' => 'Opening balance duplicates fixed successfully',
        'data' => [
            'deleted_customer_entries' => $deleted_customers,
            'deleted_supplier_entries' => $deleted_suppliers,
            'created_customer_entries' => $customer_entries,
            'created_supplier_entries' => $supplier_entries
        ]
    ]);
